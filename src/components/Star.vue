...
export default {
  ...
  props:['portrait1','portrait2','portrait3', 'data1'],
  ...
  methods:{
    ...
    makeBox(x,y){ 
      ...
      // will be changed to 'blue-box' when correct selection is made
      ...
      // conatiner that lists character selection options
      ...
      // creates a button for each character option
    ...
    checkSelection(number){
      if(number == 1){
        if(this.x > (this.data1.x1 - 25) && this.x < (this.data1.x1 + 25)){
          if(this.y > (this.data1.y1 - 25) && this.y < (this.data1.y1 + 25)){
        ...
        if(this.x > (this.data1.x2 - 25) && this.x < (this.data1.x2 + 25)){
          if(this.y > (this.data1.y2 - 25) && this.y < (this.data1.y2 + 25)){
            this.charactersFound++
            this.changeBoxID(number)
            this.markPortrait(number)
            this.checkGameOver()
        ...
        if(this.x > (this.data1.x3 - 25) && this.x < (this.data1.x3 + 25)){
          if(this.y > (this.data1.y3 - 25) && this.y < (this.data1.y3 + 25)){
            this.charactersFound++
            this.changeBoxID(number)
            this.markPortrait(number)
            this.checkGameOver()
