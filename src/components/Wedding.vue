...
<script>
export default {
  props:['portrait1','portrait2','portrait3', 'data2'],
  ...
  methods:{
    ...
    checkSelection(number){
      if(number == 1){
        if(this.x > (this.data2.x1 - 25) && this.x < (this.data2.x1 + 25)){
          if(this.y > (this.data2.y1 - 25) && this.y < (this.data2.y1 + 25)){
        ...
        if(this.x > (this.data2.x2 - 25) && this.x < (this.data2.x2 + 25)){
          if(this.y > (this.data2.y2 - 25) && this.y < (this.data2.y2 + 25)){
            this.charactersFound++
            this.changeBoxID(number)
            this.markPortrait(number)
            this.checkGameOver()
        ...
        if(this.x > (this.data2.x3 - 25) && this.x < (this.data2.x3 + 25)){
          if(this.y > (this.data2.y3 - 25) && this.y < (this.data2.y3 + 25)){
            this.charactersFound++
            this.changeBoxID(number)
            this.markPortrait(number)
            this.checkGameOver()
